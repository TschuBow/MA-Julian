...
def main():
    ...
    expander = st.beta_expander(
        f'Click here to check the paths.' # of {open_metadata_file["audio_file"]}'
        )
    ...
    with expander:
        ...
        # with expander:
            ...
            sound_file_found = os.path.isfile(audio_file_path)
            sound_files_found.append(sound_file_found)
            ts_file_found = os.path.isfile(timestamp_file_path)
            ts_files_found.append(ts_file_found)
    ...
    if sound_files_found:
        all_sound_files_found = all(sound_files_found)
        all_ts_files_found = all(ts_files_found)

        if all_sound_files_found and all_ts_files_found:
            st.write("All Audio and TS Files could be found.")
        ...
        elif not all_sound_files_found and all_ts_files_found:
            st.write("Some Audio Files couldn't be found.")
        elif all_sound_files_found and not all_ts_files_found:
            st.write(
                "Some TS Files couldn't be found."
            )
        else:
            st.write(
                "Some Audio Files and TS Files couldn't be found."
            )
